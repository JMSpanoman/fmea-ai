...
export const documentTypes: DocumentTypeDef[] = [
  ...
  req({
    ...
    description: 'Auto-filled requirements checklist with linked evidence references.',
  }),
  req({
    id: 'submission_index',
    ...
    description: 'Builds a submission-ready index of documents and versions.',
  }),
  req({
    id: 'audit_package',
    name: 'Audit Package',
    ...
    description: 'Generates an audit-ready package list and export set placeholders.',
  }),
];
