    ...
    for risk_item in risk_items:
        ...
        risk_evidence = {
            ...
            "current_version": {
                ...
                "hazard_library_id": getattr(current_version, "hazard_library_id", None) if current_version else None,
                "harm_library_id": getattr(current_version, "harm_library_id", None) if current_version else None,
                "risk_control_library_id": getattr(current_version, "risk_control_library_id", None) if current_version else None,
                "verification_library_id": getattr(current_version, "verification_library_id", None) if current_version else None,
            ...
            "versions": [
                {
                    ...
                    "hazard_library_id": getattr(v, "hazard_library_id", None),
                    "harm_library_id": getattr(v, "harm_library_id", None),
                    "risk_control_library_id": getattr(v, "risk_control_library_id", None),
                    "verification_library_id": getattr(v, "verification_library_id", None),
                    "severity": v.severity,
