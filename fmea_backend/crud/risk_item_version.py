...
def create_risk_item_version(
    ...
    db_version = RiskItemVersion(
        ...
        hazard_library_id=getattr(version_data, "hazard_library_id", None),
        harm_library_id=getattr(version_data, "harm_library_id", None),
        risk_control_library_id=getattr(version_data, "risk_control_library_id", None),
        verification_library_id=getattr(version_data, "verification_library_id", None),
