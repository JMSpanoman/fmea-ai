...
def update_risk_item(db: Session, risk_item_id: str, risk_item: RiskItemUpdate, project_id: str, changed_by: Optional[str] = None) -> Optional[RiskItem]:
    ...
    if current_version:
        ...
        version_data_dict = {
            ...
            'hazard_library_id': getattr(current_version, 'hazard_library_id', None),
            'harm_library_id': getattr(current_version, 'harm_library_id', None),
            'risk_control_library_id': getattr(current_version, 'risk_control_library_id', None),
            'verification_library_id': getattr(current_version, 'verification_library_id', None),
